...
Please note:  This project is obviously a massive undertaking (and is under heavy development) but the following gif(s) outline some of our fundamental functionality.  Much of that functionality is changing and morphing as we come closer to an alpha-stage product.
